...
import com.fauzi.reportapps.ui.history.HistoryAdapter;
import com.fauzi.reportapps.viewmodel.HistoryViewModel;

import java.util.ArrayList;
import java.util.List;

public class HistoryAdmin extends AppCompatActivity implements HistoryAdapter.HistoryAdapterCallback {
    ...
    public void onDelete(ModelDatabase modelDatabase) {
        ...
        alertDialogBuilder.setPositiveButton("Ya, Hapus", (dialogInterface, i) -> {
            ...
            Toast.makeText(HistoryAdmin.this,
