package com.fauzi.reportapps.ui.main;
...
import com.fauzi.reportapps.ActivityRegister;
import com.fauzi.reportapps.KontakActivity;
import com.fauzi.reportapps.R;
import com.fauzi.reportapps.TentangActivity;
import com.fauzi.reportapps.ui.report.ReportActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    CardView cvPemadam, cvAmbulance, cvBencana, cvHistory, cvTentang, cvLogout, cvKontak;
    ...
    private void setInitLayout() {
        ...
        cvPemadam.setOnClickListener(v -> {
            strTitle = "Laporan Pelanggaran Pelaksanaan Pemilu";
        ...
        cvAmbulance.setOnClickListener(v -> {
            strTitle = "Laporan Pelanggaran Administrasi Pemilu";
            Intent intent = new Intent(MainActivity.this, ReportActivity.class);
            intent.putExtra(ReportActivity.DATA_TITLE, strTitle);
            startActivity(intent);
        });
        ...
        cvBencana.setOnClickListener(v -> {
            strTitle = "Laporan Pelanggaran Sengketa Pemilu";
            Intent intent = new Intent(MainActivity.this, ReportActivity.class);
            intent.putExtra(ReportActivity.DATA_TITLE, strTitle);
            startActivity(intent);
        });

        cvTentang.setOnClickListener(v -> {
